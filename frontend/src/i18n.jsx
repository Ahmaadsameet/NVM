...
const copy = {
  en: {
    ...
    work: { label: "SELECTED WORK", titleBefore: "Details that", titleEmphasis: "hold up.", cta: "START A PROJECT", captions: ["PRODUCTION FLOOR", "DENIM WASH", "FABRIC & FINISHING"] },
    closing: { before: "Production your brand can", emphasis: "build on." },
  ...
  de: {
    ...
    work: { label: "AUSGEWÄHLTE ARBEITEN", titleBefore: "Details, die", titleEmphasis: "bestehen.", cta: "PROJEKT STARTEN", captions: ["PRODUKTIONSHALLE", "DENIM-WASCHUNG", "STOFF & VEREDELUNG"] },
    closing: { before: "Produktion, auf die Ihre Marke", emphasis: "bauen kann." },
  ...
  fr: {
    ...
    work: { label: "RÉALISATIONS", titleBefore: "Des détails qui", titleEmphasis: "durent.", cta: "DÉMARRER UN PROJET", captions: ["ATELIER DE PRODUCTION", "DÉLAVAGE DENIM", "TISSU & FINITION"] },
    closing: { before: "Une production sur laquelle votre marque peut", emphasis: "compter." },
