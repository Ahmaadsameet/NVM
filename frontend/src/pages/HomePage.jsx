...
export default class HomePage extends React.Component {
  ...
  render() {
    ...
    return <div className="app"><ScrollEffects /><Header menuOpen={menuOpen} onToggle={() => this.setState({ menuOpen: !menuOpen })} /><MobileMenu open={menuOpen} onClose={() => this.setState({ menuOpen: false })} /><main><Hero /><Ticker /><IntroSection /><CapabilitiesSection /><ProcessSection /><QualitySection /><DifferenceSection /><WorkSection /><ClosingSection /><BookingSection state={this.state} onSubmit={this.handleSubmit} onBriefSubmit={this.handleBriefSubmit} onToggleBrief={() => this.setState({ briefOpen: !this.state.briefOpen })} /></main><footer><div className="footer-main"><div><img className="footer-logo" src="/assets/nwm-logo-header.png" alt="North Weave Mills" /><p>A German production partner<br />for apparel brands.</p></div><div><span className="eyebrow">PAGES</span><a href="#make">Capabilities</a><a href="#process">Process</a><a href="#quality">Quality</a><a href="#book">Contact / Book a Call</a></div><div><span className="eyebrow">CONTACT</span><a href="mailto:hello@northweavemills.com">hello@northweavemills.com</a><a href="#book">Book a Call</a></div></div><div className="footer-bottom"><span>© 2026 NORTH WEAVE MILLS</span><span>GERMANY · NWM</span></div></footer></div>;
  }
}
